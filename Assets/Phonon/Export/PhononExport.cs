...
namespace Phonon
{
	...
	{
        [DllImport("phononxp")]
        public static extern void   iplInitializeExport(IntPtr allocCallback, IntPtr freeCallback, IntPtr easyAllocCallback, IntPtr easyFreeCallback);

        [DllImport("phononxp")]
        public static extern void   iplReleaseExport();
        ...
        [DllImport("phononxp")]
        public static extern void iplSaveFinalizedScene(IntPtr scene, string fileName);

        [DllImport("phononxp")]
        public static extern void iplLoadFinalizedScene(string fileName, [In, Out] ref IntPtr scene);
	}
