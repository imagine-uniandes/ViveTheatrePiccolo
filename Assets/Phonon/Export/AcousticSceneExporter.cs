...
{
    public static void LoadPreExportedScene()
    {
        ...
        if (System.IO.File.Exists(fileName))
            Phonon.Export.iplLoadFinalizedScene(fileName, ref scene);
        else
            Debug.LogError("Please Pre-Export Scene. Find the option here: Phonon > Scene");
    }
    ...
    public static void ExportScene()
    {
        ...
        Phonon.Export.iplInitializeExport(IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero);
    ...
    public static void Destroy()
    {
        if (scene != IntPtr.Zero)
        {
            ...
            Phonon.Export.iplReleaseExport();
            scene = IntPtr.Zero;
        }
