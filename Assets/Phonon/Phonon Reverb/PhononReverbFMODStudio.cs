...
namespace Phonon
{
	...
	//
	public static class ReverbFMODStudio
	{
		[DllImport("phononrv_fmod")]
        ...
        [DllImport("phononrv_fmod")]
		public static extern void iplFMODSetImpulseResponse(IntPtr impulseResponse);
		
		[DllImport("phononrv_fmod")]
		public static extern void iplFMODSetImpulseResponseRaw(float[] impulseResponse);
	}
