...
//
//	ReverbBakeSettings
//	Component for specifying bake settings as a preset or as custom values.
//

public class ReverbBakeSettings : MonoBehaviour
{
    //
    //	Data members.
    //
    ...
    public ReverbBakeSettingsPreset Preset;

    // The actual value of the bake settings.
    public ReverbBakeSettingsValue Value;

    // Flags for choosing what kind of reverb to bake.
    public bool BakeParametricReverb = true;
    public bool BakeConvolutionReverb = true;
}