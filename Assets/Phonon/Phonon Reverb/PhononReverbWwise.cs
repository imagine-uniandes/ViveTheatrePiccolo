...
namespace Phonon
{
	...
	//
	public static class ReverbWwise
	{
#if UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX
        [DllImport("libphononrv_wwise")]
        public static extern void iplWwiseSetReverbSettings(Phonon.ReverbSettings settings);

        [DllImport("libphononrv_wwise")]
        public static extern void iplWwiseSetImpulseResponse(IntPtr impulseResponse);

        [DllImport("libphononrv_wwise")]
        public static extern void iplWwiseSetImpulseResponseRaw(float[] impulseResponse);
#else    
        [DllImport("phononrv_wwise")]
        public static extern void iplWwiseSetReverbSettings(Phonon.ReverbSettings settings);
